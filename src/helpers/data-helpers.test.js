...
describe("getData function", () => {
  it("Converts Celcius to Farehnheit correctly, to 1 decimal place", () => {
    const dataObj = getData(sensorsTest, readingsTest, "Temperature Sensor", "F")
  ...
  it("Returns the correct filtered data", () => {
    const dataObjHumFiltered = getData(sensorsTest, readingsTest, "Humidity Sensor", "F")
    const dataObjTempFiltered = getData(sensorsTest, readingsTest, "Temperature Sensor", "F")
