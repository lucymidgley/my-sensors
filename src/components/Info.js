    ...
    <Fragment>
      ...
      {visible && <div className="Info">
        ...
        <ul>
          ...
          <li>Typing in the search box allows you to filter all the results by name</li>
          <li>Clicking the column name checkboxes lets you choose which columns to show</li>
        </ul>
        <button className="Close-button" onClick={() => setVisible(false)}>Close</button>  
        </div>}
    </Fragment>
  )
}